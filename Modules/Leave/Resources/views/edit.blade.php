              ...
              <div class="row">
                <div class="col-md-3 col-12">
                  <div class="mb-1">
                    ...
                    <input type="text" value="{{ $leave->date_from }}" name="date_from" id="from_date" class="form-control flatpickr-basic"  placeholder="YYYY-MM-DD" required readonly/>
                  </div>
                </div>
                <div class="col-md-3 col-12">
                  <div class="mb-1">
                    <label class="form-label" for="to_date"> To </label>
                    <input type="text" value="{{ $leave->date_to }}" name="date_to" id="to_date" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" required readonly/>
                  </div>
                </div>
