    ...
    <td class="bg_dark email-section" style="text-align:center;">
        <div class="heading-section heading-section-white">
            ...
            <table class="rwd-table bg_dark">
                ...
                <tr>
                    <td data-th="Person">{{ $leave->user->name }}</td>
                    <td data-th="From">{{ $leave->from_date }}</td>
                    <td data-th="To">{{ $leave->to_date }}</td>
                    <td data-th="Department">{{ $leave->department->name }}</td>
                    <td data-th="Status">
                        @if ($leave->admin_confirmed == 1)
                            Approved
