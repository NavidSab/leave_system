...
<div class="main-menu menu-fixed {{($configData['theme'] === 'dark') ? 'menu-dark' : 'menu-light'}} menu-accordion menu-shadow" data-scroll-to-active="true">
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      @endif
      <li class=" navigation-header"><span data-i18n="College Managment">Leave Managment</span><i data-feather="more-horizontal"></i>
      </li>
      ...
      <li class=" nav-item">
        <a class="d-flex align-items-center" href="{{url('/department')}}">
          ...
          <span class="menu-title text-truncate" data-i18n="Department">Add Department</span>
        </a>
      </li>
      @endif
      <li class=" nav-item">
        <a class="d-flex align-items-center" href="{{url('/leave')}}">
          <i data-feather="plus"></i>
          <span class="menu-title text-truncate" data-i18n="Leave">Add Leave</span>
        </a>
      </li>
  </ul>
  </div>
